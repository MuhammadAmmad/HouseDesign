...
namespace HouseDesign.Classes
{
    public class WallObject: WorldObject
    {
        ...
        public WallObject(Wall wall, float height): base()
        {
            ...
            vertices.Add(p3);
            vertices.Add(p4);
            vertices.Add(new Point3d(p1.X, height, p1.Z));
            vertices.Add(new Point3d(p2.X, height, p2.Z));
            vertices.Add(new Point3d(p3.X, height, p3.Z));
            vertices.Add(new Point3d(p4.X, height, p4.Z));
